 ...
 *		RpgTrigger, HoldFire, PlayerToggles, EntityManager, and (as of
 *		the fps/phase/enemy-count migration) DebugStats, PhaseClock and
 *		EnemyStats - the types extracted from globals.h so far.
 *
